...
data/png/atlanta.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 12060` --out $@

data/png/austin.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 12420` --out $@
...
data/png/boston.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 14460` --out $@

data/png/buffalo.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 15380` --out $@

data/png/charlotte.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 16740` --out $@

data/png/chicago.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 16980` --out $@

data/png/cincinnati.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 17140` --out $@

data/png/cleveland.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 17460` --out $@

data/png/columbus.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 18140` --out $@
...
data/png/houston.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 26420` --out $@

data/png/indianapolis.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 26900` --out $@

data/png/jacksonville.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 27260` --out $@

data/png/kansas_city.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 28140` --out $@
...
data/png/louisville.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 31140` --out $@

data/png/memphis.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 32820` --out $@

data/png/miami.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 33100` --out $@

data/png/milwaukee.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 33340` --out $@

data/png/minneapolis.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 33460` --out $@

data/png/nashville.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 34980` --out $@

data/png/new_orleans.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 35380` --out $@

data/png/new_york.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 35620` --out $@

data/png/oklahoma_city.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 36420` --out $@

data/png/orlando.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 36740` --out $@
...
data/png/pittsburgh.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 38300` --out $@

data/png/portland.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 38900` --out $@

data/png/providence.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 39300` --out $@

data/png/raleigh.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 39580` --out $@

data/png/richmond.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 40060` --out $@

data/png/riverside.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 40140` --out $@
...
data/png/salt_lake_city.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 41620` --out $@
...
data/png/seattle.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 42660` --out $@

data/png/st_louis.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 41180` --out $@

data/png/tampa.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 45300` --out $@

data/png/virginia_beach.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 47260` --out $@

data/png/washington.png:
	mkdir -p $(dir $@)
	script/rasterize-metro-shapefile --in `script/export-metro-shapefile -d metro_poverty -m 47900` --out $@
